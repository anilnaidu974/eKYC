...
ap.add_argument("-n", "--name", required=False, help="name of trained model to perform spoofing detection")
ap.add_argument("-d", "--device", required=False, help="camera identifier/video to acquire the image")
...
# if __name__ == "__main__":
    ...
    # # Load model
    clf = None
    path = "/home/anil/Downloads/spoof_images/Anil.jpg"
    try:
